...
if fitSpectra:
	fileList,energyList,nameList,fitLowArr,fitHighArr = getFiles(pix)
	...
	for file in fileList:
		...
		popt, enRes, pcov = enResFitting.enResPlot(settings,fitLow=fitLowArr[i], fitHigh=fitHighArr[i], savedir=dataDir, integral=traceInteg)
...
if pix==1:
	...
	#chip003
		...
		if traceInteg:
			print("reading the correct values")
